export default {
  ...
  register: {
    ...
    noInstitutionFoundDesc: 'Show this app to your institution and join us.',
  ...
  badReport: {
    ...
    messages: {
      ...
      oops: 'Oops!',
      reportSent2: 'You have already sent a survey through this option today.',
      reportNotSent:
  ...
  locationRequest: {
    ...
    errorMessage: 'Please allow the use of location in your device settings.',
    cancelText: 'Cancel',
    okText: 'OK',
  },
  maps: {
  ...
  vaccination: {
    ...
    messageError2: 'You have reached the dose limit for this type of vaccine.',
    messageError3: 'Check that the date is correct or correct the old dose.',
  ...
  surveillance: {
    ...
    message: 'you are not an active vigilant yet. Do you want to participate?',
    cancelButton: 'No',
