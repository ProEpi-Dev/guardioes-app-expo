export default {
  ...
  register: {
    ...
    noInstitutionFound: 'Não possuímos instituições cadastradas nesse local',
  ...
  vaccination: {
    ...
    messageError2: 'Você atingiu o limite de doses para esse tipo de vacina.',
    messageError3: 'Verifique se a data está correta ou corrija a dose antiga.',
  ...
  finishProfile: {
    ...
    identifier: {
      ...
      default: {
        ...
        validationError:
          'O identificador deve conter apenas letras e números, sem espaços ou caracteres especiais.',
      },
