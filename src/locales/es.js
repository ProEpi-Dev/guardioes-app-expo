export default {
  ...
  register: {
    ...
    noInstitutionFound: 'No tenemos instituciones registradas en este sitio',
  ...
  vaccination: {
    ...
    messageError2: 'Ha alcanzado el límite de dosis para este tipo de vacuna.',
    messageError3:
  ...
  vbe: {
    alerts: {
      feelingRegistered: 'Sentimiento registrado',
      youSelected: 'Has seleccionado: {{message}}',
    },
    feelingCard: {
      nothingHappened: 'NADA OCURRIÓ',
      report: 'INFORMAR',
      title: '¿Quieres informar una señal de alerta?',
    },
    mySignals: 'Mis Señales',
    filter: 'Filtro',
    emptyList: 'Ningún reporte encontrado.',
    successAnimation: '¡{{day}} Marcado!',
    streak: 'Racha actual: {{currentStreak}} día(s)',
  },
  learn: {
    title: 'Aprender',
    emptyList: 'No se encontraron ciclos para tu contexto.',
  },
  trail: {
    title: 'Ruta: {{title}}',
    next: 'Continuar',
  ...
  sequence: {
    ...
    inarow: 'seguido',
    inarows: 'seguidos',
    participation: 'Has participado por',
    longestStreak: 'Racha más larga',
    totalParticipation: 'Participación Total',
  },
  emptyList: 'Ningún quiz disponible en este momento.',
  resultScreen: {
    detail: 'Detalle de las preguntas',
    return: 'Volver a la ruta',
  },
  quizQuestions: {
    loading: 'Cargando...',
  ...
  quizInfo: {
    ...
    instruction1: 'Este quiz contiene preguntas de opción múltiple',
    instruction2: 'El objetivo es probar tus conocimientos sobre "{{title}}"',
    instruction3: 'Lee detenidamente cada pregunta antes de responder',
    instructionScore: 'Puntuación mínima para aprobar: {{passingScore}} puntos',
    instructionAutoGrade:
      'Al finalizar, tu calificación se calculará automáticamente',
    instructionTime: 'Límite de tiempo: {{timeLimitMinutes}} minutos',
    attemptStart: 'Estás iniciando el',
    attemptNumber: 'Intento #{{currentAttempt}}',
    attemptsAllowed: 'de {{maxAttempts}} intentos permitidos',
